...
//        h->SetDirectory(0);          for the current histogram h
	...
	// Set the target
	//
	target tharget(46,110,2940,180.0);
	experiment.set_targ(tharget);

	//
	// Set the beam
	//
	experiment.set_beam("Mg",21,67);	
...
// 	bool excited_beam_like=true;
	...
	TFile outfile("Pd110MgNaS3Upsteam67MeV.root","RECREATE");
	...
	experiment.set_beam("Na",21,67);	
	experiment.set_elastic();
	
	experiment.reset_detectors();
	add_S3(experiment,-30);
