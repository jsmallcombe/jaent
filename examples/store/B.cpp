...
//        h->SetDirectory(0);          for the current histogram h
	...
	// Set the target
	//
	double density_targ=12.023*(110.0/106.42);//enriched
	double density_back=1;//g/cm2	
	experiment.set_targ(target(46,110,1600,0));//1.6 mg/cm2 Pt110
	...
	double excited_Z=-1;
	double excited_A=-1;
	double initial_state_MeV = 1.017;
	double transition_keV = 1017;
	bool excited_beam_like=true;
	double halflife=0.0108;//in ns
	string dist="examples/Pd.txt";// leave blank for a uniform distribution
