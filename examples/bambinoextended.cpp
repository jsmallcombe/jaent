...
// 	double ZZb=20;	
	...
	for(int bt=0;bt<2;bt++){
		...
		if(bt==0){//beam gammas first
			expr.set_ejec(tharget.Z(),tharget.A());
		}else{//then targets
			beamgamma=!beamgamma;
