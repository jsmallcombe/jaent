...
detector::detector() : energy(),energyG(), mass(), hit_pat(),name(), detector_world_place(), detector_world_rotate(),detector_norm()
{
...
// 		obj.detector_xy->Copy(*detector_xy);
		...
		energy=obj.energy;mass=obj.mass;hit_pat=obj.hit_pat;plane=obj.plane;name=obj.name;
	}
